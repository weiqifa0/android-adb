...
int adb_commandline(int argc, const char **argv) {
    ...
    } else if (!strcmp(argv[0], "evergrande.ai.root") || !strcmp(argv[0], "unroot")) {
		if(!strcmp(argv[0], "evergrande.ai.root")){
			printf("evergrande.ai.root\n");
			fprintf(stderr,"#evergrande.ai.root#\n");
			return adb_root("root") ? 0 : 1;
		}	
